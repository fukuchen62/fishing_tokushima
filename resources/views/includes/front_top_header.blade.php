    ...
    <div class="topreturn">
        <div class="topreturn__thread">
            <svg class="topreturn__btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96.52 83.77">
                <path class="hook"
                    d="m91.84,46.69c-2.59,0-4.68,2.1-4.68,4.68,0,2.16,1.46,3.97,3.45,4.51v5.65h0c0,3.77-3.06,6.83-6.83,6.83-3.3,0-6.06-2.34-6.69-5.45l.69.25c.16.06.31-.09.26-.25l-1.83-6.46c-.05-.19-.31-.2-.38-.02l-2.09,5.07c-.04.11.01.23.12.27l.58.21c.23,4.96,4.32,8.91,9.34,8.91s9.35-4.19,9.35-9.35v-5.66c1.96-.56,3.4-2.36,3.4-4.5,0-2.59-2.1-4.68-4.68-4.68Zm0,6.91c-1.23,0-2.23-1-2.23-2.23s1-2.23,2.23-2.23,2.23,1,2.23,2.23-1,2.23-2.23,2.23Z" />
                <g id="topreturn">
                    <g>
                        <path class="bubble"
                            d="m67.98,55.75c-1.3,14.9-14.51,23.03-31.32,27.09-21.53,5.2-33.72-12.32-31.32-27.09s17.33-30.29,34.63-30.29,30.05,6.98,28.02,30.29Z" />
                        <path class="bubble"
                            d="m37.95,26.38c0,5.75-9.95,18.2-22.23,18.2S0,37.26,0,27.21,6.69,10.14,18.97,10.14s18.97,6.19,18.97,16.24Z" />
                        <path class="bubble"
                            d="m58.06,83.34c-2.71.31-8.92-2.09-9.34-5.86s2.9-5.22,7.64-5.75,8.27,1.15,8.7,4.92c.43,3.77-2.26,6.16-6.99,6.7Z" />
                        <path class="bubble"
                            d="m34.88.05c3.28.59,5.41.7,6.35,2.31,1.77,3.03.37,4.2-3.6,6.12-2.47,1.19-5.4-.56-6.23-3.42-.7-2.43.91-5.47,3.48-5.01Z" />
                    </g>
                    ...
                    <g>
                        <path class="fish"
                            d="m45.5,55.75c0-3.76.99-7.45,2.88-10.7l.76-1.31c-1.58-.38-3.2-.61-4.82-.71-2.17-1.67-5.42-3.66-9.15-4.29l-2.3-.42,1.33,6.13c-4.13,1.4-7.77,4.25-10.18,6.21-.47-.39-.95-.77-1.46-1.14-3.94-2.87-8.19-3.15-8.36-3.16l-1.93-.1.26,1.91c.03.2.67,4.43,3.14,7.58-2.46,3.15-3.1,7.38-3.14,7.58l-.26,1.95,1.93-.13c.18,0,4.43-.29,8.36-3.16.5-.37.98-.74,1.44-1.13,2.42,1.97,6.06,4.82,10.19,6.22l-1.31,6.13,2.3-.42c3.72-.63,6.95-2.62,9.12-4.29,1.65-.1,3.28-.34,4.89-.72l-.78-1.31c-1.89-3.25-2.89-6.95-2.89-10.71Z" />
                        <path class="fish"
                            d="m61.77,52.24c-.58-.98-1.64-2.47-3.39-3.99-1.82-1.57-3.9-2.81-6.14-3.67l-1.11,1.94c-1.61,2.77-2.45,5.91-2.46,9.11,0,3.2.84,6.34,2.45,9.11l1.16,1.94c2.22-.85,4.28-2.07,6.09-3.62,3.15-2.72,4.63-6.14,4.63-7.43,0-1.22-.79-2.65-1.23-3.39Zm-8.28,3.39c-.31,0-.62-.09-.88-.27-.26-.17-.46-.42-.58-.71-.12-.29-.15-.61-.09-.92.06-.31.21-.59.43-.81.22-.22.5-.37.81-.43.31-.06.63-.03.92.09.29.12.54.32.71.58.17.26.27.57.27.88,0,.42-.17.82-.46,1.12-.3.3-.7.46-1.12.46Z" />
                    </g>
                </g>
            </svg>
        </div>
