...
@section('content')
    ...
    <table>
        ...
        <tr><th>カテゴリーID: </th><td><input type="text" name="category_id"
            value="{{$knowledge->category_id}}"required></td></tr>
        <tr><th>タイトル: </th><td><input type="text" name="title"
            value="{{$knowledge->title}}"required></td></tr>
        <tr><th>概要: </th><td><input type="text" name="overview"
            value="{{$knowledge->overview}}"required></td></tr>
            <tr>
                <th>記事の内容：</th>
                <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    value="{{$knowledge->thumbnail}}"required>
                </td>
            </tr>
            <tr>
                <th>表示フラグ：</th>
                <td>
                    ...
                    value="{{$knowledge->is_show}}"required>
                </td>
            </tr>

        <tr><th></th><td><input type="submit"value="修正">
            <a href="{{route('knowledgeremove',['id'=>$knowledge->id])}}">削除</a></td></tr>
    </table>
    </form>
@endsection
