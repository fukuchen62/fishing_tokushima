        ...
        <div class="knowledge__section--box">
            <div class="knowledge__section--flexbox knowledge_odd">
                ...
                @component('components.front_index_card')
                    ...
                    @endslot
                    @slot('card_src')
                        {{ asset('storage/images') }}/knowledge_2_2_800x600.jpg
                    @endslot
                    @slot('card_alt')
                        icon_fish.svg
                    @endslot
            ...
            <div class="knowledge__section--flexbox knowledge_even">
                ...
                @component('components.front_index_card')
                    ...
                    @endslot
                    @slot('card_src')
                        {{ asset('storage/images') }}/knowledge_24_1_960x540.jpg
                    @endslot
                    @slot('card_alt')
                        img_neko_700_3.jpg
                    @endslot
            ...
            <div class="knowledge__section--flexbox knowledge_odd">
                ...
                @component('components.front_index_card')
                    ...
                    @endslot
                    @slot('card_src')
                        {{ asset('storage/images') }}/knowledge_10_5_800x600.jpg
                    @endslot
                    @slot('card_alt')
                        img_neko_700_3.jpg
                    @endslot
            ...
            <div class="knowledge__section--flexbox knowledge_even">
                ...
                @component('components.front_index_card')
                    ...
                    @endslot
                    @slot('card_src')
                        {{ asset('storage/images') }}/knowledge_13_2_800x600.jpg
                    @endslot
                    @slot('card_alt')
                        img_neko_700_3.jpg
                    @endslot
        ...
        <div class="plansection__flexblock">
            ...
            <div class="plansection__block plan1">
                <a href="{{ route('plansinfo', ['id' => 1]) }}">
                    <img class="planimg" src="{{ asset('storage/images') }}/plans_1_1_640x480.jpg"
