...
<section class="firstsection knowledge__section expand p__lr">
    ...
    <div class="knowledge__section--box">
        <div class="knowledge__section--flexbox knowledge_odd">
            ...
            @endslot
            @slot('card_src')
            {{ asset('storage/images') }}/knowledge_2_2_800x800.jpg
            @endslot
            @slot('card_alt')
            icon_fish.svg
            @endslot
        ...
        <div class="knowledge__section--flexbox knowledge_even">
            ...
            @endslot
            @slot('card_src')
            {{ asset('storage/images') }}/knowledge_24_1_800x800.jpg
            @endslot
            @slot('card_alt')
            img_neko_700_3.jpg
            @endslot
        ...
        <div class="knowledge__section--flexbox knowledge_odd">
            ...
            @endslot
            @slot('card_src')
            {{ asset('storage/images') }}/knowledge_10_5_800x800.jpg
            @endslot
            @slot('card_alt')
            img_neko_700_3.jpg
            @endslot
        ...
        <div class="knowledge__section--flexbox knowledge_even">
            ...
            @endslot
            @slot('card_src')
            {{ asset('storage/images') }}/knowledge_13_2_800x800.jpg
            @endslot
            @slot('card_alt')
            img_neko_700_3.jpg
            @endslot
    ...
    <div class="plansection__flexblock">
        ...
        <div class="plansection__block plan1">
            <a href="{{ route('plansinfo', ['id' => 1]) }}">
                <img class="planimg" src="{{ asset('storage/images') }}/plans_1_1_800x800.jpg" alt="サビキでイワシ釣り">
            </a>
        ...
        <div class="plansection__block plan2">
            <a class="block" href="{{ route('plansinfo', ['id' => 2]) }}">
                <img class="planimg" src="{{ asset('storage/images') }}/knowledge_8_1_800x800.jpg" alt="浮きでアジ釣り">
                <p class="circle-text fontrotate">
        ...
        <div class="plansection__block plan3">
            <a href="{{ route('plansinfo', ['id' => 3]) }}">
                <img class="planimg" src="{{ asset('storage/images') }}/plans_3_1_800x800.jpg" alt="ルアーでアジ釣り">
                <p class="circle-text fontrotate">
