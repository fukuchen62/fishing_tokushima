    ...
    <div class="container">
        ...
        <div class="shallow expand">
            ...
            <section class="evacuation__section p__lr">
                ...
                <p class="warning__text">釣りをする際には、必ず災害時の緊急避難場所をチェックしてください。</p>
                <p>釣りの最中に地震が起きたら、一番最初に危惧しなければならないことは「津波」です。
                    海の防波堤やサーフ・磯釣りなどをしている方は、まず釣りを中止して高台を探しましょう。
                    「あまり揺れなかったから津波もこないだろう」という油断は大敵です。
                </p>
                <p>津波が発生する条件は、下記の通りと言われています。</p>
                <ul class="evacuation__box--warning">
                    <li>海の底の比較的浅い場所が震源の場合</li>
                    <li>地震の規模を表すマグニチュードが約6.5以上の場合</li>
                </ul>

                <p>釣り場では、情報収集が遅れがちで、のんびり情報を集めている間に津波が到達してしまう恐れがあります。
                    津波は地震が起こってから最短で２分程度で海岸線に到達することもあるそうです。
                    高台を目指しながらラジオや携帯電話を使って情報を集めましょう。</p>
