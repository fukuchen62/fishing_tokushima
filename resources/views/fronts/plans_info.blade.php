        ...
        <div class="shallow expand">
            ...
            <section class="overview__section p__lr">
                <div class="overview__box">
                    <div class="max-width-box">
                        ...
                        @else
                            <img class="overview__box--img plan__img" src="https://placehold.jp/559x314.png">
                        @endif
                    </div>
            ...
            <div>
                <ul class="detail__img--shell">
                    <li><img src="{{ asset('assets/images/shell-1.png') }}" width="40" height="40" alt="">
                    </li>
                    <li><img src="{{ asset('assets/images/shell-2.png') }}" width="40" height="40" alt="">
                    </li>
                    <li><img src="{{ asset('assets/images/shell-3.png') }}" width="40" height="40" alt="">
                    </li>
                    <li><img src="{{ asset('assets/images/ukiwa.png') }}" width="40" height="40" alt="">
                    </li>
                    <li><img src="{{ asset('assets/images/shell-1.png') }}" width="40" height="40" alt="">
                    </li>
                    <li><img src="{{ asset('assets/images/shell-2.png') }}" width="40" height="40" alt="">
            ...
            <ul class="card__area">
                ...
                @if (isset($connection1))
                    @foreach ($connection1 as $key => $value)
                        <li class="card__p">
                            <a class="card card__skin" href="{{ route('plansinfo') }}?id= {{ $value->id }}" ;>
                                @if ($value->eye_catch != '')
                                    <img class="card__img" src="{{ asset('storage/images') }}/{{ $value->eye_catch }}"
                                        alt="{{ $value->eye_catch }}">
                                @else
                                    <img class="card__img" src="https://placehold.jp/320x240.png" alt="">
                                @endif
